...
const Cookie = () => {
  ...
  useEffect(() => {
    const isDismissed =
      localStorage.getItem(COOKIE_NOTICE_DISMISSED) === 'false';
  ...
  return (
    <>
      <div
        className={`fixed inset-x-0 bottom-0 z-50 pb-2 sm:pb-5 ${
          dismissed
              ...
              <div className="flex flex-wrap items-center justify-between">
                ...
                <div className="order-2 flex-shrink-0 sm:order-3 sm:ml-2">
                  <button
                    onClick={dismiss}
                    type="button"
                    className="-mr-1 flex rounded-md p-2 hover:bg-brand-green focus:outline-none focus:ring-2 focus:ring-white"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
