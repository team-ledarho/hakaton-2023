...
const Header = () => {
  ...
  return (
    <>
   <header className="px-5 py-8 bg-secondary-100">
  ...
  />
          ...
          {isMenuOpen && (
            <div className="fixed top-0 left-0 w-full h-full bg-gray-800 z-50">
              <div className="my-8 mx-5 text-white">
                <div className="flex justify-between items-start">
                  <div>
                    <h2 className="text-3xl bold pb-3">Зарзар</h2>
                    <a href="mailto:support@spentoday.com" className="hover:underline">
                      support@zarzar.ru
                    </a>
                  </div>
                  <button onClick={toggleMenu} className="text-5xl text-white p-2 h-10 w-10">
                ...
                <div className="text-5xl bold absolute bottom-8 transition-colors">
                  <a className="block pb-6 hover:text-gray-500" onClick={toggleMenu} href="/#aboutUs">
                    Про нас
                  </a>
                  <a className="block pb-6 hover:text-gray-500" onClick={toggleMenu} href="/login">
                    Войти
                  </a>
                  <a className="block pb-6 hover:text-gray-500" onClick={toggleMenu} href="/#benefits">
                    Процесс
                  </a>
                  <a className="block pb-6 hover:text-gray-500" onClick={toggleMenu} href="/#price">
                    Подписки
                  </a>
                  <a className="block pb-6 hover:text-gray-500" onClick={toggleMenu} href="/#faq">
                    ЧАО
                  </a>
                </div>
              </div>
